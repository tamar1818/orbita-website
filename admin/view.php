...
$TEXT_FIELDS = [
    ...
    'home.hero.entity'  => ['მთავარი — სააგენტოს აღწერა (SEO)', 'area', 'Webico — ვებ დეველოპმენტის სააგენტო თბილისში: საიტის დამზადება, WordPress, ონლაინ მაღაზიები, UI/UX დიზაინი და SEO.'],
