...
<head>
  ...
  <title>გვერდი ვერ მოიძებნა (404) — ვებიკო</title>
  <meta name="description" content="მოთხოვნილი გვერდი ვერ მოიძებნა. დაბრუნდით მთავარ გვერდზე ან გაეცანით ჩვენს სერვისებს.">
  <meta name="theme-color" content="#0d0d0d">
  <meta property="og:type" content="website">
  <meta property="og:locale" content="ka_GE">
  <meta property="og:site_name" content="ვებიკო">
  <meta property="og:title" content="კონტაქტი — მოგვწერეთ | ვებიკო">
  <meta property="og:description" content="დაგვიკავშირდით უფასო კონსულტაციისთვის: +995 32 2 00 00 00, hello@webico.io. თბილისი, ჭავჭავაძის გამზირი 45. პასუხს 24 საათში მიიღებთ.">
  <meta property="og:url" content="https://webico.io/contact">
    ...
    <section class="page-hero pattern-grid">
      <div class="container">
        <div class="page-hero__inner">
          <span class="eyebrow">შეცდომა 404</span>
          <h1>გვერდი ვერ მოიძებნა</h1>
          <p>შესაძლოა მისამართი შეიცვალა, გვერდი წაიშალა, ან ბმულში დაიკარგა სიმბოლო.
            ქვემოთ მოცემული ბმულებით სწრაფად იპოვით საჭიროს.</p>
          <div class="btn-row">
            <a class="btn btn--primary" href="/">მთავარ გვერდზე დაბრუნება</a>
            <a class="btn btn--ghost" href="/contact">დაგვიკავშირდით</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <div class="section-head section-head--center">
          <span class="eyebrow eyebrow--accent">სავარაუდოდ ეძებთ</span>
          <h2>ჩვენი სერვისები</h2>
        </div>
        <div class="grid grid--2">
          <article class="card card--link">
            <h3>ვებსაიტების დიზაინი და შექმნა</h3>
            <p>კორპორატიული საიტები, ონლაინ მაღაზიები და ვებ-აპლიკაციები.</p>
            <a class="link-arrow" href="/service-web-development">დეტალურად</a>
          </article>
          <article class="card card--link">
            <h3>SEO ოპტიმიზაცია</h3>
            <p>ტექნიკური აუდიტი, საკვანძო სიტყვები და კონტენტ-სტრატეგია.</p>
            <a class="link-arrow" href="/service-seo">დეტალურად</a>
          </article>
          <article class="card card--link">
            <h3>ციფრული მარკეტინგი</h3>
            <p>Google Ads, Meta და TikTok კამპანიები გაზომვადი შედეგით.</p>
            <a class="link-arrow" href="/service-marketing">დეტალურად</a>
          </article>
          <article class="card card--link">
            <h3>ბრენდის ვიზუალური იდენტობა</h3>
            <p>ლოგო, ბრენდბუქი და ინტერფეისის დიზაინი.</p>
            <a class="link-arrow" href="/service-branding">დეტალურად</a>
          </article>
        </div>
      </div>
    </section>
